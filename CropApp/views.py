    ...
    try:
        if request.method == 'POST':
            ...
            context = {'current_temp': temp_current, 'city': city,
                       ...
                       'tom': tom, 'nexttom': nexttom, 'nexttotom': nexttotom, 'cur_desc1': cur_desc1, 'cur_desc2': cur_desc2, 'cur_desc3': cur_desc3, "avgtemps": avgtemps, "datelist": keylist, 'max_temp': max_temp, 'min_temp': min_temp, 'serie_1': serie_1, 'serie_2': serie_2, 'serie_3': serie_3, 'temp_1': temp_1, 'temp_2': temp_2, 'temp_3': temp_3, "date1": keylist[0], "date2": keylist[1], "date3": keylist[2], "table_data": table_data
                       }
